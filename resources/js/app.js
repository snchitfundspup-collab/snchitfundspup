...
window.SN_TRANSLATIONS = {
    ...
    en: {
        ...
        change_it_now: 'Change it now',
        chit_statement: 'Chit statement',
        chit_to_pay_now: 'Chit — to pay now',
        choose_account: 'Choose your account',
        completed_word: 'Completed',
        customer_login: 'Customer login',
        customer_login_help: 'Signs in at',
        customer_login_link: 'Customer? Sign in here',
        customer_note: 'Customer\'s note:',
        customer_orders: 'Customer Orders',
        customer_orders_subtitle: 'Rice customers ordered from their own pages. Make the sale to send the bill, or cancel the order.',
        default_password_hint: 'Your current password is the default one the office gave you.',
        default_password_note: 'You are using the default password.',
        dismiss_reason: 'Reason for the customer (optional)',
        dismiss_word: 'Dismiss',
        download_statement: 'Download statement',
        drawn_word: 'Drawn',
        ends_on: 'Ends on',
        estimated_total: 'Estimated total',
        from_customer_order: 'From the customer\'s order',
        group_already_started: 'This group has already started, so no one can be added.',
        group_full: 'Full',
        group_full_note: 'This group is full. Please call the office about the next group.',
        im_interested: 'I\'m interested',
        invoice_word_title: 'Invoice',
        join_decided_by_office: 'The office confirms every new member and will call you.',
        join_request_waiting: 'customer wants to join a group',
        join_requests: 'Join Requests',
        join_requests_subtitle: 'Customers who asked to join a group that is forming. Add them to the group or dismiss the request.',
        join_requests_waiting: 'customers want to join a group',
        joined_note: 'You have a seat in this group. Your first payment is due on the start date.',
        make_sale: 'Make sale',
        ...
        my_bills: 'Bills & Statement',
        my_bills_subtitle: 'Every rice bill and payment with SN Traders, and what is left to pay. Tap a bill to download it.',
        my_groups: 'My Groups',
        my_groups_subtitle: 'The chit groups you are in. Open one to see every month, your receipts and the withdrawal plan.',
        my_orders: 'My Orders',
        my_orders_subtitle: 'Rice you ordered. Once the office makes the bill, it appears in Bills & Statement.',
        my_receipts: 'My receipts',
        new_order_waiting: 'new order from a customer',
        new_orders_waiting: 'new orders from customers',
        new_password_optional: 'New password (leave empty to keep it)',
        no_bills_yet: 'No bills yet.',
        no_groups_yet: 'You are not in a chit group yet. See the upcoming groups below.',
        no_orders_here: 'No orders here.',
        no_orders_yet: 'You have not ordered rice yet.',
        no_requests_here: 'No requests here.',
        no_rice_listed: 'No rice is listed right now.',
        no_upcoming_groups: 'No new groups right now. Please check again later.',
        nothing_to_pay: 'Nothing to pay now',
        order_note: 'Note for the office (optional)',
        order_price_note: 'The final bill is made by the office at the day\'s price.',
        order_prices_today: 'Prices are today\'s; change anything before saving.',
        order_rice: 'Order rice',
        order_waiting: 'Waiting',
        orders_new: 'New',
        orders_waiting: 'waiting for the office',
        ...
        portal_login_description: 'See your chit groups, payments and receipts, and order rice.',
        portal_login_help: 'First time? Use the password given by the office — you will then choose your own.',
        forgot_password_call: 'Forgot your password? Call the office to reset it:',
        choose_password_first: 'Please choose your own password to continue.',
        choose_password_why: 'For your safety, the password given by the office works only once. Choose a new one (not snchitfunds).',
        portal_password_description: 'Choose your own password. You sign in with your phone number and this password.',
        portal_welcome: 'Welcome',
        price_on_request: 'Price on request',
        request_not_accepted: 'Not accepted',
        request_sent: 'Request sent',
        request_waiting_note: 'The office will call you to confirm.',
        requests_added: 'Added',
        requests_dismissed: 'Dismissed',
        requests_waiting: 'Waiting',
        reset_to_default: 'Reset to default',
        rice_and_order: 'Rice & Order',
        rice_balance: 'Rice — balance',
        rice_from_traders: 'Rice from SN Traders',
        rice_subtitle: 'Choose how many bags you want and send the order. The office will call you to confirm and deliver.',
        seats_in_groups: 'seats in chit groups',
        seats_left: 'seats left',
        seats_wanted: 'Seats',
        send_order: 'Send order',
        shared_phone_note: 'This phone number is used by more than one customer.',
        staff_login_link: 'Office staff login',
        starting_soon: 'Starting soon',
        starts_on: 'Starts on',
        to_pay_now: 'To pay now',
        total_bills: 'Total bills',
        upcoming_groups: 'Upcoming Groups',
        upcoming_subtitle: 'New chit groups starting soon. Open one to see the monthly amount and the withdrawal plan.',
        want_to_join: 'Want to join this group?',
        who_is_signing_in: 'Who is signing in?',
        with_phone_number: 'with the phone number above.',
        withdraw_request: 'Withdraw request',
        withdrawal_plan: 'Withdrawal plan',
        ...
        no_customer_usage: 'No customer has signed in yet.',
    ...
    ta: {
        ...
        invoice_word: 'பில்',
        months_completed: 'முடிந்த மாதங்கள்',
        months_remaining: 'மீதமுள்ள மாதங்கள்',
        months_paid: 'செலுத்திய மாதங்கள்',
        months_pending: 'நிலுவை மாதங்கள்',
        next_due: 'அடுத்த தவணை',
        done_word: 'முடிந்தது',
        done_title: 'முடிந்தது',
        add_to_group: 'குழுவில் சேர்',
        asked_on: 'கேட்ட தேதி',
        available_word: 'கிடைக்கும்',
        back_to_login: 'உள்நுழைவுக்குத் திரும்பு',
        bill_word: 'பில்',
        call_office: 'அலுவலகத்தை அழை',
        cancel_order: 'ரத்து செய்',
        cancelled_word: 'ரத்து செய்யப்பட்டது',
        change_it_now: 'இப்போதே மாற்றுங்கள்',
        chit_statement: 'சீட்டு அறிக்கை',
        chit_to_pay_now: 'சீட்டு — இப்போது செலுத்த',
        choose_account: 'உங்கள் கணக்கைத் தேர்ந்தெடுக்கவும்',
        completed_word: 'முடிந்தது',
        customer_login: 'வாடிக்கையாளர் உள்நுழைவு',
        customer_login_help: 'உள்நுழையும் இடம்',
        customer_login_link: 'வாடிக்கையாளரா? இங்கே உள்நுழையவும்',
        customer_note: 'வாடிக்கையாளர் குறிப்பு:',
        customer_orders: 'வாடிக்கையாளர் ஆர்டர்கள்',
        customer_orders_subtitle: 'வாடிக்கையாளர்கள் ஆர்டர் செய்த அரிசி. விற்பனை செய்து பில் அனுப்புங்கள், அல்லது ஆர்டரை ரத்து செய்யுங்கள்.',
        default_password_hint: 'உங்கள் தற்போதைய கடவுச்சொல் அலுவலகம் கொடுத்த இயல்புநிலை கடவுச்சொல்.',
        default_password_note: 'நீங்கள் இயல்புநிலை கடவுச்சொல்லைப் பயன்படுத்துகிறீர்கள்.',
        dismiss_reason: 'வாடிக்கையாளருக்கான காரணம் (விருப்பம்)',
        dismiss_word: 'நிராகரி',
        download_statement: 'அறிக்கையைப் பதிவிறக்கு',
        drawn_word: 'குலுக்கப்பட்டது',
        ends_on: 'முடியும் தேதி',
        estimated_total: 'மதிப்பிடப்பட்ட மொத்தம்',
        from_customer_order: 'வாடிக்கையாளர் ஆர்டரிலிருந்து',
        group_already_started: 'இந்தக் குழு ஏற்கனவே தொடங்கிவிட்டது, யாரையும் சேர்க்க முடியாது.',
        group_full: 'நிரம்பியது',
        group_full_note: 'இந்தக் குழு நிரம்பிவிட்டது. அடுத்த குழு பற்றி அலுவலகத்தை அழையுங்கள்.',
        im_interested: 'எனக்கு விருப்பம்',
        invoice_word_title: 'பில்',
        join_decided_by_office: 'ஒவ்வொரு புதிய உறுப்பினரையும் அலுவலகம் உறுதி செய்து உங்களை அழைக்கும்.',
        join_request_waiting: 'வாடிக்கையாளர் குழுவில் சேர விரும்புகிறார்',
        join_requests: 'சேர்க்கை கோரிக்கைகள்',
        join_requests_subtitle: 'உருவாகும் குழுவில் சேரக் கேட்ட வாடிக்கையாளர்கள். குழுவில் சேருங்கள் அல்லது கோரிக்கையை நிராகரியுங்கள்.',
        join_requests_waiting: 'வாடிக்கையாளர்கள் குழுவில் சேர விரும்புகிறார்கள்',
        joined_note: 'இந்தக் குழுவில் உங்களுக்கு இடம் உள்ளது. முதல் தவணை தொடக்க தேதியில்.',
        make_sale: 'விற்பனை செய்',
        members_word: 'உறுப்பினர்கள்',
        menu_account: 'கணக்கு',
        menu_chit_funds: 'SN சீட்டு நிதி',
        menu_traders: 'SN டிரேடர்ஸ்',
        monthly_payments: 'மாதாந்திர தவணைகள்',
        my_account: 'என் கணக்கு',
        my_bills: 'பில்கள் & அறிக்கை',
        my_bills_subtitle: 'SN டிரேடர்ஸில் உங்கள் அனைத்து அரிசி பில்களும் செலுத்தியதும், மீதமும். பதிவிறக்க பில்லைத் தட்டவும்.',
        my_groups: 'என் குழுக்கள்',
        my_groups_subtitle: 'நீங்கள் உள்ள சீட்டுக் குழுக்கள். ஒவ்வொரு மாதமும், ரசீதுகளும், எடுப்புத் திட்டமும் பார்க்க திறக்கவும்.',
        my_orders: 'என் ஆர்டர்கள்',
        my_orders_subtitle: 'நீங்கள் ஆர்டர் செய்த அரிசி. அலுவலகம் பில் போட்டதும் பில்கள் & அறிக்கையில் தெரியும்.',
        my_receipts: 'என் ரசீதுகள்',
        new_order_waiting: 'வாடிக்கையாளரிடமிருந்து புதிய ஆர்டர்',
        new_orders_waiting: 'வாடிக்கையாளர்களிடமிருந்து புதிய ஆர்டர்கள்',
        new_password_optional: 'புதிய கடவுச்சொல் (மாற்றாமல் இருக்க காலியாக விடவும்)',
        no_bills_yet: 'இதுவரை பில்கள் இல்லை.',
        no_groups_yet: 'நீங்கள் இன்னும் எந்த சீட்டுக் குழுவிலும் இல்லை. வரவிருக்கும் குழுக்களைப் பாருங்கள்.',
        no_orders_here: 'இங்கே ஆர்டர்கள் இல்லை.',
        no_orders_yet: 'நீங்கள் இன்னும் அரிசி ஆர்டர் செய்யவில்லை.',
        no_requests_here: 'இங்கே கோரிக்கைகள் இல்லை.',
        no_rice_listed: 'இப்போது அரிசி எதுவும் பட்டியலில் இல்லை.',
        no_upcoming_groups: 'இப்போது புதிய குழுக்கள் இல்லை. பிறகு பாருங்கள்.',
        nothing_to_pay: 'இப்போது செலுத்த எதுவும் இல்லை',
        order_note: 'அலுவலகத்திற்கான குறிப்பு (விருப்பம்)',
        order_price_note: 'இறுதி பில் அன்றைய விலையில் அலுவலகத்தால் போடப்படும்.',
        order_prices_today: 'விலைகள் இன்றையவை; சேமிக்கும் முன் மாற்றலாம்.',
        order_rice: 'அரிசி ஆர்டர்',
        order_waiting: 'காத்திருக்கிறது',
        orders_new: 'புதியவை',
        orders_waiting: 'அலுவலகத்திற்காக காத்திருக்கிறது',
        out_of_stock: 'இருப்பு இல்லை',
        password_word: 'கடவுச்சொல்',
        per_bag: 'மூட்டைக்கு',
        period_word: 'காலம்',
        phone_number: 'தொலைபேசி எண்',
        phone_placeholder: '10 இலக்க கைபேசி எண்',
        portal_login_description: 'உங்கள் சீட்டுக் குழுக்கள், தவணைகள், ரசீதுகளைப் பாருங்கள், அரிசி ஆர்டர் செய்யுங்கள்.',
        portal_login_help: 'முதல் முறையா? அலுவலகம் கொடுத்த கடவுச்சொல்லைப் பயன்படுத்துங்கள் — பிறகு உங்கள் சொந்த கடவுச்சொல்லைத் தேர்ந்தெடுப்பீர்கள்.',
        forgot_password_call: 'கடவுச்சொல் மறந்துவிட்டதா? மாற்ற அலுவலகத்தை அழையுங்கள்:',
        choose_password_first: 'தொடர உங்கள் சொந்த கடவுச்சொல்லைத் தேர்ந்தெடுங்கள்.',
        choose_password_why: 'உங்கள் பாதுகாப்புக்காக, அலுவலகம் கொடுத்த கடவுச்சொல் ஒருமுறை மட்டுமே. புதிய கடவுச்சொல்லைத் தேர்ந்தெடுங்கள் (snchitfunds அல்ல).',
        portal_password_description: 'உங்கள் சொந்த கடவுச்சொல்லைத் தேர்ந்தெடுங்கள். தொலைபேசி எண்ணும் இந்தக் கடவுச்சொல்லும் கொண்டு உள்நுழைவீர்கள்.',
        portal_welcome: 'வரவேற்கிறோம்',
        price_on_request: 'விலைக்கு அழைக்கவும்',
        request_not_accepted: 'ஏற்கப்படவில்லை',
        request_sent: 'கோரிக்கை அனுப்பப்பட்டது',
        request_waiting_note: 'உறுதி செய்ய அலுவலகம் உங்களை அழைக்கும்.',
        requests_added: 'சேர்க்கப்பட்டது',
        requests_dismissed: 'நிராகரிக்கப்பட்டது',
        requests_waiting: 'காத்திருப்பவை',
        reset_to_default: 'இயல்புநிலைக்கு மாற்று',
        rice_and_order: 'அரிசி & ஆர்டர்',
        rice_balance: 'அரிசி — மீதம்',
        rice_from_traders: 'SN டிரேடர்ஸ் அரிசி',
        rice_subtitle: 'எத்தனை மூட்டைகள் வேண்டும் எனத் தேர்ந்தெடுத்து ஆர்டர் அனுப்புங்கள். அலுவலகம் உறுதி செய்து டெலிவரி செய்யும்.',
        seats_in_groups: 'சீட்டுக் குழுக்களில் இடங்கள்',
        seats_left: 'மீதமுள்ள இடங்கள்',
        seats_wanted: 'இடங்கள்',
        send_order: 'ஆர்டர் அனுப்பு',
        shared_phone_note: 'இந்த எண்ணை ஒன்றுக்கு மேற்பட்ட வாடிக்கையாளர்கள் பயன்படுத்துகிறார்கள்.',
        staff_login_link: 'அலுவலக பணியாளர் உள்நுழைவு',
        starting_soon: 'விரைவில் தொடக்கம்',
        starts_on: 'தொடங்கும் தேதி',
        to_pay_now: 'இப்போது செலுத்த',
        total_bills: 'மொத்த பில்கள்',
        upcoming_groups: 'வரவிருக்கும் குழுக்கள்',
        upcoming_subtitle: 'விரைவில் தொடங்கும் புதிய சீட்டுக் குழுக்கள். மாதத் தொகை மற்றும் எடுப்புத் திட்டம் பார்க்க திறக்கவும்.',
        want_to_join: 'இந்தக் குழுவில் சேர விருப்பமா?',
        who_is_signing_in: 'யார் உள்நுழைகிறார்கள்?',
        with_phone_number: 'மேலே உள்ள தொலைபேசி எண்ணுடன்.',
        withdraw_request: 'கோரிக்கையைத் திரும்பப் பெறு',
        withdrawal_plan: 'எடுப்புத் திட்டம்',
        you_joined: 'நீங்கள் சேர்ந்துவிட்டீர்கள்',
        you_owe: 'நீங்கள் செலுத்த வேண்டியது',
        you_won: 'நீங்கள் வென்றீர்கள்',
        menu_usage: 'பயன்பாடு',
        ...
        no_customer_usage: 'இதுவரை எந்த வாடிக்கையாளரும் உள்நுழையவில்லை.',
...
window.changeLanguage = function (language) {
    ...
    /* the server reads this too, so printed reports and PDFs use the same language */
    document.cookie =
        'sn_language=' + (language === 'ta' ? 'ta' : 'en') + '; path=/; max-age=31536000; SameSite=Lax';
...
document.addEventListener(
    ...
    function () {
        ...
        */
        ...
        /* dark unless the person chose light */
        const theme =
            savedTheme === 'light'
                ? 'light'
                : 'dark';
