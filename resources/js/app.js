...
window.SN_TRANSLATIONS = {
    ...
    en: {
        ...
        varieties_subtitle: 'The rice you buy and sell, with the usual bag weight (it can be changed on each bill).',
    ...
    ta: {
        ...
        varieties_subtitle: 'நீங்கள் வாங்கி விற்கும் அரிசி, வழக்கமான மூட்டை எடையுடன் (ஒவ்வொரு பில்லிலும் மாற்றலாம்).',
